...
async function run() {
  ...
  divBot.innerHTML = `
        ...
        <div class="text-white bg-[rgb(30,31,32)] px-[20px] py-[10px] rounded-lg">${md.render(
          text
        )}</div>
    `;
...
let wider_left_header_content = document.querySelectorAll(
  ".wider_left_header_content"
);
